print("  _____       _                       ")
print(" |  __ \     (_)                      ")
print(" | |__) |__ _ _ _ __ ___   __ _ _ __  ")
print(" |  _  // _` | | '_ ` _ \ / _` | '_ \ ")
print(" | | \ \ (_| | | | | | | | (_| | | | |")
print(" |_|  \_\__,_|_|_| |_| |_|\__,_|_| |_|\n")
print("=================================================")
author = "Bg.Pateng & raiman"
print("Author: " + author)
...
while True:
        ...
        if response.status_code == 200:
            ...
            if len(messages) == 0:
                ...
                response = requests.post(f'https://discord.com/api/v9/channels/{channel_id}/messages/{message_id}', headers=headers)
